        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('admin/pages/forms/addproduct')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/forms/add-type')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new Type Proudct</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/forms/addnew-manu')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new Manufacture</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/forms/adduser')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new users</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/forms/addorder')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add new Order</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('admin/pages/tables/order')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Order Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/tables/type-product')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Type Product Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/tables/product')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/tables/user')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Users Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('admin/pages/tables/manufacture')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manufacture</p>
                </a>
              </li>
...
<script src="{{ url ('adminAsset/dist/js/demo.js') }}"></script>
