                    ...
                    <div class="col-lg-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                ...
                                @endforeach
                                @if($role == '1')
                                    <div><a style="color:black" href="{{ url('/admin/home')}}"><i style="color:black" class="fa fa-user"></i> Admin</a></div>
                                    @else
                                    <div>English</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="{{ url('listw')}}"><i class="fa fa-heart"></i> <span>
                            @if(session())
                                {{count($count)}}
                            @endif
                            </span></a></li>
                            <li><a href="{{ url('cart')}}"><i class="fa fa-shopping-bag"></i> <span>@if(session())
                                {{count($countcart)}}
                            @endif</span></a></li>
                        </ul>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="{{ url('search-result')}}" method="get">
                                <input type="text" name="keysearch" placeholder="What do yo u need?">
